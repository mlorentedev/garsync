...
| 021 | 2026-09-24 | A Dependabot `update-types` Ignore Cannot Suppress a Security Update | [lesson-021-dependabot-ignore-cannot-suppress-a-security-update.md](lesson-021-dependabot-ignore-cannot-suppress-a-security-update.md) | `dependabot`, `security`, `npm`, `ci`, `gotcha` |
| 022 | 2026-09-05 | An acceptance criterion backed only by a dependency's behaviour is not enforced | [lesson-022-acceptance-criterion-delegated-to-a-dependency.md](lesson-022-acceptance-criterion-delegated-to-a-dependency.md) | `testing`, `cors`, `dependencies`, `security`, `gotcha` |
| 023 | 2026-09-25 | A `grep` in a make target turns a failing check into a green line | [lesson-023-grep-in-a-make-target-turns-a-failure-into-a-green-line.md](lesson-023-grep-in-a-make-target-turns-a-failure-into-a-green-line.md) | `makefile`, `ci`, `gates`, `testing`, `gotcha` |
| 024 | 2026-09-25 | `hmac.compare_digest` raises on non-ASCII `str`, turning an auth check into an unauthenticated 500 | [lesson-024-compare-digest-raises-on-non-ascii-input.md](lesson-024-compare-digest-raises-on-non-ascii-input.md) | `python`, `security`, `auth`, `testing`, `gotcha` |
| 025 | 2026-09-25 | A payload-carried offset beats a configured zone | [lesson-025-a-payload-carried-offset-beats-a-configured-zone.md](lesson-025-a-payload-carried-offset-beats-a-configured-zone.md) | `timezones`, `migrations`, `garmin`, `testing`, `gotcha` |
| 026 | 2026-09-25 | Moving a writer without its reader freezes an endpoint silently | [lesson-026-moving-a-writer-without-its-reader-freezes-an-endpoint.md](lesson-026-moving-a-writer-without-its-reader-freezes-an-endpoint.md) | `sqlite`, `refactor`, `api`, `testing`, `gotcha` |
| 027 | 2026-09-25 | SQLite commits DDL outside an explicit transaction, and SQLAlchemy rolls back what it did not open | [lesson-027-sqlite-commits-ddl-outside-an-explicit-transaction.md](lesson-027-sqlite-commits-ddl-outside-an-explicit-transaction.md) | `sqlite`, `sqlalchemy`, `alembic`, `transactions`, `gotcha` |
